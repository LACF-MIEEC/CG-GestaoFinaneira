...
QT_MOC_LITERAL(1, 10, 13), // "gastoAccepted"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8), // "QDialog*"
QT_MOC_LITERAL(4, 34, 21) // "on_buttonBox_accepted"

    },
    "AddDialog\0gastoAccepted\0\0QDialog*\0"
...
void AddDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gastoAccepted((*reinterpret_cast< QDialog*(*)>(_a[1]))); break;
        ...
        {
            typedef void (AddDialog::*_t)(QDialog * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddDialog::gastoAccepted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AddDialog::gastoAccepted(QDialog * _t1)
{
